const getById = id => document.getElementById(id);
  ...
  //AGREGAMOS LA INFO DE ESTA FUNCIÓN QUE SE ENCARGARÁ DE DIVIDIR POR PALABRAS
  ...
  // TODO
  //AGREGAMOS LA FUNCIÓN PARA ACCEDER A LAS PALABRAS 
  const word_index = () => {
    let {text, view} = getIO();
  ...
  // TODO
  //AGREGAMOS LA FUNCIÓN QUE SE ENCARGA DE BUSCAR LAS PALABRAS, ORDENARLAS Y MOSTRAS LAS REPETIDAS
  const search_words = () => {
    let {text, view, search} = getIO();
